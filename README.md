...
Create a TOML configuration file with the following structure. Connection
details (Manager server address, cert/key, CA certs) are provided via CLI
arguments.
